...
supported_currency = ['LVL','EUR','USD', 'UAH', 'THB']
supported_language = ['lv_LV','en_US','ru_RU', 'uk_UA', 'th_TH']
...
def wordify(chunk, chunknr, language):
    ...
    if language == 'lv_LV':
        ...
        skaitli = [u'ศูนย์', u'หนึ่ง', u'สอง', u'สาม', u'สี่', u'ห้า', u'หก',
                   u'เจ็ด', u'แปด', u'เก้า']
        skaitlix = [u'zero', u'สิบ', u'ยี่สิบ', u'สามสิบ', u'สี่สิบ', u'ห้าสิบ', u'หกสิบ',
                    u'เจ็ดสิบ', u'แปดสิบ', u'เก้าสิบ']
        skaitli_teens = [u'ten', u'eleven', u'twelve', u'thirteen', u'fourteen',
                         u'fifteen', u'sixteen', u'seventeen', u'eighteen', u'nineteen']
        daudzums = [u'ร้อย', u'พัน', u'หมื่น', u'แสน', u'ล้าน']
        daudzumsx = daudzums
