...
class wizard_report_summary_logistic_by_period(osv.osv_memory):
    ...
    def create_report(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'wizard.ineco.logistic.report.period.summary'
        ...
        host_ids = self.pool.get('ineco.report.config').search(cr, uid, [('type','=','report.logistic.summary.period')])
        hostname = 'localhost'
        if host_ids:
    ...
    _name = "wizard.ineco.logistic.report.period.summary"
    ...
    _defaults = { 
        ...
        'name': lambda *a: 'delivery_logistic_summary_by_period.pdf',
        'format': 'pdf'
    }    


wizard_report_summary_logistic_by_period()
