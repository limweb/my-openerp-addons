...
class wizard_report_delivery(osv.osv_memory):
    ...
    def create_report(self, cr, uid, ids, context=None):
        ...
        if criteries:
            ...
            a = j.runReport('/Openerp/OA/omg-delivery-order',this.format, {'pick_ids': criteries})
            this.name = "%s.%s" % ('delivery', this.format)
            buf = StringIO()
            buf.write(a['data'])
    ...
    _name = "wizard.report.delivery"
    _description = "New Delivery Report Style"
    ...
    _defaults = { 
        ...
        'name': lambda *a: 'delivery.pdf'
    }    


wizard_report_delivery()
