...
class wizard_ineco_stock_report_print(osv.osv_memory):
    ...
    def create_report(self, cr, uid, ids, context=None):
        ...
        host_ids = self.pool.get('ineco.report.config').search(cr, uid, [('type','=','report.ineco.stock.report')])
        hostname = 'localhost'
        if host_ids:
            ...
            raise osv.except_osv(_('Error !'),_('You have not config report report.ineco.stock.report in ineco.report.config!'))
    ...
    _name = "wizard.ineco.stock.report"
    _description = "Print Stock Report"
    ...
    _defaults = { 
        ...
        'name': lambda *a: 'stock_report.pdf',
        'format': 'pdf'
    }    

wizard_ineco_stock_report_print()
