...
class wizard_ineco_logistic_report_kitting_slip(osv.osv_memory):
    ...
    def create_report(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'wizard.ineco.logistic.report.kitting.slip'
        ...
        host_ids = self.pool.get('ineco.report.config').search(cr, uid, [('type','=','report.kitting.slip')])
        hostname = 'localhost'
        if host_ids:
            ...
            raise osv.except_osv(_('Error !'),_('You have not config report ineco.kitting in ineco.report.config!'))
    ...
    _name = "wizard.ineco.logistic.report.kitting.slip"
    ...
    _defaults = { 
        ...
        'name': lambda *a: 'delivery_kitting.pdf',
        'format': 'pdf'
    }    


wizard_ineco_logistic_report_kitting_slip()
