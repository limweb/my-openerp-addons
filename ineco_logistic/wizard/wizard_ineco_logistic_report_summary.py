...
class wizard_ineco_logistic_report_summary(osv.osv_memory):
    ...
    def create_report(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'wizard.ineco.logistic.report.summary'
        ...
        host_ids = self.pool.get('ineco.report.config').search(cr, uid, [('type','=','report.logistic.summary')])
        hostname = 'localhost'
        if host_ids:
    ...
    _name = "wizard.ineco.logistic.report.summary"
    ...
    _defaults = { 
        ...
        'name': lambda *a: 'delivery_logistic_summary.pdf',
        'format': 'pdf'
    }    


wizard_ineco_logistic_report_summary()
