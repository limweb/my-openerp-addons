...
class wizard_ineco_logistic_report_kitting(osv.osv_memory):
    ...
    def create_report(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'wizard.ineco.logistic.report.kitting'
        ...
        host_ids = self.pool.get('ineco.report.config').search(cr, uid, [('type','=','report.kitting')])
        hostname = 'localhost'
        if host_ids:
    ...
    _name = "wizard.ineco.logistic.report.kitting"
...
wizard_ineco_logistic_report_kitting()
