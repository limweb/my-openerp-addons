...
#
#02-01-2012        POP-001        Create New Report
...
class wizard_ineco_logistic_report_delivery_pack(osv.osv_memory):
    ...
    def create_report(self, cr, uid, ids, context=None):
        ...
        datas['model'] = 'wizard.ineco.logistic.report.delivery.pack'
        ...
        host_ids = self.pool.get('ineco.report.config').search(cr, uid, [('type','=','report.delivery.pack')])
        hostname = 'localhost'
        if host_ids:
            ...
            raise osv.except_osv(_('Error !'),_('You have not config report ineco.deliery.pack in ineco.report.config!'))
    ...
    _name = "wizard.ineco.logistic.report.delivery.pack"
    _description = "Delivery Pack Report"
    ...
    _defaults = { 
        ...
        'name': lambda *a: 'delivery_pack.pdf',
        'format': 'pdf'
    }    


wizard_ineco_logistic_report_delivery_pack()
